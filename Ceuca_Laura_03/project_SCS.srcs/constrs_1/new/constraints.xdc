...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { mult_btn }]; #IO_L4N_T0_D05_14 Sch=btnu
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { confirm_number }]; #IO_L12P_T1_MRCC_14 Sch=btnl

set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { confirm_sel }]; #IO_L10N_T1_D15_14 Sch=btnr
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {confirm_sel}];
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { div_btn }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {div_btn}];
