...
HD_PWD='C:/Users/Ioana/Desktop/scs/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AluUnit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AluUnit.tcl -notrace
