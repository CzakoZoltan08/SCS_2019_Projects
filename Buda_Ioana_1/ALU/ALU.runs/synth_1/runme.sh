...
HD_PWD='C:/Users/Ioana/Desktop/scs/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AluUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AluUnit.tcl
