...
public class BeqView extends JFrame {
	...
	public BeqView() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/images/fixed_images/beq_img0.jpg")).getImage();
	...
	public String[] getImages() {
		File file = new File(getClass().getResource("/images/beq_operation/").getFile());
	...
	public void showImage(int index) {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/images/beq_operation/" + imageName));
