...
public class AddView extends JFrame {
	...
	public AddView() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/images/fixed_images/add_img0.jpg")).getImage();
	...
	// until now, was specified just how the frame will look like when will be initialized
	
	// get images list
	// obtain a list of names of images from resource folder
	public String[] getImages() {
		File file = new File(getClass().getResource("/images/add_operation/").getFile());
		String[] imagesList = file.list();
		return imagesList;
	}

	// display the image by index
	// parameter = index of the image in the list of names of images returned by "getImages" method	
	// retrieves the image and displays it into the JLabel
	public void showImage(int index) {
		String[] imagesList = getImages();
		String imageName = imagesList[index];
		ImageIcon icon = new ImageIcon(getClass().getResource("/images/add_operation/" + imageName));
