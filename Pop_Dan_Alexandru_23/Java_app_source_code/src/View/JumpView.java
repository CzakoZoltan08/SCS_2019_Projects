...
public class JumpView extends JFrame {
	...
	public JumpView() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/images/fixed_images/jump_img0.jpg")).getImage();
	...
	public String[] getImages() {
		File file = new File(getClass().getResource("/images/jump_operation/").getFile());
	...
	public void showImage(int index) {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/images/jump_operation/" + imageName));
