...
public class LW_view extends JFrame {
	...
	public LW_view() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/images/fixed_images/lw_img0.jpg")).getImage();
	...
	public String[] getImages() {
		File file = new File(getClass().getResource("/images/lw_operation/").getFile());
	...
	public void showImage(int index) {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/images/lw_operation/" + imageName));
