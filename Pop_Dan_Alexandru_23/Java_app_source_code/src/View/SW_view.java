...
public class SW_view extends JFrame {
	...
	public SW_view() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/images/fixed_images/sw_img0.jpg")).getImage();
	...
	public String[] getImages() {
		File file = new File(getClass().getResource("/images/sw_operation/").getFile());
	...
	public void showImage(int index) {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/images/sw_operation/" + imageName));
